	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 container">
				<form action="../ControleDeTransacao" method="post">
					<div class="form-group">
						<label for="nomeCerveja">Nome:</label> <input id="nomeCerveja"
							type="text" name="nomeCerveja" placeholder="Nome da cerveja"
					...
					<div class="form-group">
						<label for="tipoCerveja">Tipo:</label> <input id="tipoCerveja"
							type="number" name="tipoCerveja"
							placeholder="Número (trocar campo para list com os tipos de cerveja)"
							class="form-control" required>
					</div>
					...
					<div class="form-group">
						<label for="descricaoCerveja">Descrição:</label> <input
							...
							placeholder="Descreva detalhes de sua cerveja (sabor, aroma, cor etc)"
							class="form-control" required>
					</div>

					<div class="form-group">
						<label for="ibu">IBU:</label> <input id="ibu" type="number"
							name="ibu" min="0" step="1" class="form-control" required>
					</div>

					<div class="form-group">
						<label for="abv">ABV (%):</label> <input id="abv" type="number"
							name="abv" class="form-control" min="0" step="0.1" required>
					</div>

					<button type="submit" name="cadastrarCerveja"
						class="btn btn-primary btn-lg login-button" value="salvarCerveja">Salvar</button>
